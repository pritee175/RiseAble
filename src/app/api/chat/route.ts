...
Your role:
- Help users find disability-friendly job opportunities (curated listings with remote/WFH options, flexible hours, and accessibility features)
...
- Features: curated jobs, 8 govt schemes, AI chatbot, 3D ISL avatar, voice navigation, WCAG 2.1+
...
function getFallbackResponse(input: string, lang: string): string {
  ...
  if (lang === "hi") {
    ...
    if (lower.includes("hello") || lower.includes("hi") || lower.includes("नमस्ते"))
      return "नमस्ते! मैं RiseAble AI असिस्टेंट हूं। मैं आपकी नौकरी ढूंढने या सरकारी योजनाएं समझने में मदद कर सकता हूं।";
    return "कृपया जॉब, या सरकारी योजनाओं के बारे में पूछें। मैं आपकी मदद करने के लिए यहां हूं!";
  }

  if (lower.includes("job") || lower.includes("work") || lower.includes("employ") || lower.includes("career"))
    return "We have curated job listings from disability-friendly employers with WFH options and flexible hours. Check the Jobs page!";
  ...
  if (lower.includes("hello") || lower.includes("hi") || lower.includes("hey"))
    return "Hello! I'm the RiseAble AI Assistant. I can help you search for jobs or understand government schemes. What would you like to know?";
  if (lower.includes("thank"))
    return "You're welcome! I'm always here to help. Feel free to ask anything about jobs or government schemes.";
